...
export default class resultadoTest extends Phaser.Scene // Manager de la escena que da el resultado del test.
{
    ...
    preload() {
        // IMAGENES:
        // Amarillo:
        this.load.image('virtuoso', "./assets/juego/personalidad/AmarilloAnimador.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('aventurero', "./assets/juego/personalidad/AmarilloAventurero.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('emprendedor', "./assets/juego/personalidad/AmarilloEmprendedor.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('animador', "./assets/juego/personalidad/AmarilloAnimador.png"); // Cargamos la imagen de volver atras (provisional).
        // Morado:
        this.load.image('arquitecto', "./assets/juego/personalidad/MoradoArquitecto.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('logico', "./assets/juego/personalidad/MoradoLogico.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('comandante', "./assets/juego/personalidad/MoradoComandante.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('innovador', "./assets/juego/personalidad/MoradoInnovador.png"); // Cargamos la imagen de volver atras (provisional).
        // Verde:
        this.load.image('abogado', "./assets/juego/personalidad/VerdeAbogado.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('mediador', "./assets/juego/personalidad/VerdeMediador.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('protagonista', "./assets/juego/personalidad/VerdeProtagonista.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('activista', "./assets/juego/personalidad/VerdeActivista.png"); // Cargamos la imagen de volver atras (provisional).
        // Azul:
        this.load.image('logista', "./assets/juego/personalidad/AzulLogista.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('defensor', "./assets/juego/personalidad/AzulDefensor.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('ejecutivo', "./assets/juego/personalidad/AzulEjecutivo.png"); // Cargamos la imagen de volver atras (provisional).
        this.load.image('consul', "./assets/juego/personalidad/AzulConsul.png"); // Cargamos la imagen de volver atras (provisional).
        // Boton:
